...
//
//import com.example.codeclan.capstoneproject.Campagna.accomodations.models.Hotel;
...
//    public void before(){
//        host = new Host("a", "a");
//        hotel = new Hotel("AA", host);
//        hotelRoom = new HotelRoom("1", RoomType.DOUBLE, 50, hotel);
